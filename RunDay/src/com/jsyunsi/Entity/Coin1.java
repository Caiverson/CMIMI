...
public class Coin1 {
	...
	public Coin1() {
		...
		y = random.nextInt(120) + 160;
		
	}
	private void initCoin1() {
		try {
			rw1 = ImageIO.read(new File("image/21.png"));
			rw2 = ImageIO.read(new File("image/22.png"));
	...
	public void paintCoin1(Graphics g) {
